...
periodic_table = {
  ...
  "Be": {"weight": 9.01  , 'ord':   4, "valency": (2,)},
  "B":  {"weight": 10.81 , 'ord':   5, "valency": (3,)},
  "C":  {"weight": 12.011, 'ord':   6, "valency": (4,)},
  "N":  {"weight": 14.007, 'ord':   7, "valency": (3,5)},
  "O":  {"weight": 15.999, 'ord':   8, "valency": (2,)},
  "F":  {"weight": 18.998, 'ord':   9, "valency": (1,)},
  "Ne": {"weight": 20.18 , 'ord':  10, "valency": (0,2)},
  "Na": {"weight": 22.990, 'ord':  11, "valency": (1,)},
  "Mg": {"weight": 24.31 , 'ord':  12, "valency": (2,)},
  "Al": {"weight": 26.98 , 'ord':  13, "valency": (3,)},
  "Si": {"weight": 28.09 , 'ord':  14, "valency": (4,)},
  "P":  {"weight": 30.974, 'ord':  15, "valency": (3,5)},
  "S":  {"weight": 32.064, 'ord':  16, "valency": (2,4,6)},
  "Cl": {"weight": 35.453, 'ord':  17, "valency": (1,5,7)},
  ...
  "Zr": {"weight": 91.22 , 'ord':   1, "valency": (4,)},
  "Nb": {"weight": 92.91 , 'ord':   1, "valency": (3,5)},
  "Mo": {"weight": 95.94 , 'ord':   1, "valency": (3,5,6)},
  "Tc": {"weight": 97.00 , 'ord':   1, "valency": (5,7)},
  "Ru": {"weight": 101.07, 'ord':   1, "valency": (3,4,6,8)},
  "Rh": {"weight": 102.91, 'ord':   1, "valency": (3,4)},
  "Pd": {"weight": 106.42, 'ord':   1, "valency": (2,4)},
  "Ag": {"weight": 107.87, 'ord':   1, "valency": (1,)},
  "Cd": {"weight": 112.41, 'ord':   1, "valency": (2,)},
  "In": {"weight": 114.82, 'ord':   1, "valency": (3,)},
  "Sn": {"weight": 118.69, 'ord':   1, "valency": (2,4)},
  "Sb": {"weight": 121.75, 'ord':   1, "valency": (3,5)},
  "Te": {"weight": 127.60, 'ord':   1, "valency": (2,4,6)},
  "I":  {"weight":126.904, 'ord':   1, "valency": (1,5,7)},
  "Xe": {"weight": 131.30, 'ord':   1, "valency": (0,2)},
  "Cs": {"weight": 132.91, 'ord':   1, "valency": (1,)},
  "Ba": {"weight": 137.33, 'ord':   1, "valency": (2,)},
  "La": {"weight": 138.91, 'ord':   1, "valency": (3,)},
  "Hf": {"weight": 178.49, 'ord':   1, "valency": (4,)},
  "Ta": {"weight": 180.95, 'ord':   1, "valency": (5,)},
  "W":  {"weight": 183.85, 'ord':   1, "valency": (6,)},
  "Re": {"weight": 186.21, 'ord':   1, "valency": (7,)},
  "Os": {"weight": 190.20, 'ord':   1, "valency": (4,6,8)},
  "Ir": {"weight": 192.22, 'ord':   1, "valency": (3,4,6)},
  "Pt": {"weight": 195.09, 'ord':   1, "valency": (2,4)},
  "Au": {"weight": 196.97, 'ord':   1, "valency": (1,3)},
  "Hg": {"weight": 200.59, 'ord':   1, "valency": (1,2)},
  "Tl": {"weight": 204.37, 'ord':   1, "valency": (1,3)},
  "Pb": {"weight": 207.2 , 'ord':   1, "valency": (2,4)},
  "Bi": {"weight": 208.98, 'ord':   1, "valency": (3,5)},
